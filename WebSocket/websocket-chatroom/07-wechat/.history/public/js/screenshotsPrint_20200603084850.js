...
// 千万不要在本地运行尝试，toDataURL()， 报错跨域问题查了3小时2年前
/**
 * 打印截取区域
 ...
 * @param canvasId
 */
async function clipScreenshots(canvasId, username, avatar){
  clipImg = await canvasExt.drawRect(canvasId, "red", defaultStrokeWidth);
  console.log(clipImg)
